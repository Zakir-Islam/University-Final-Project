...
{
    public partial class newconnec : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Exam_Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Student_FId = table.Column<int>(nullable: false),
                    subject_FId = table.Column<int>(nullable: false),
                    mid = table.Column<double>(nullable: false),
                    final = table.Column<double>(nullable: false),
                    sessional = table.Column<double>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExamResults_Students_Student_Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamResults_Student_Id",
                table: "ExamResults",
                column: "Student_Id");
